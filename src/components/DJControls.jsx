const DJControls = ({ hushMode, cpm, volume, onHushChange, onCpmChange, onVolumeChange }) => {
    return (
        <>
            ...
            <div className="form-check mb-3">
                <input className="form-check-input" type="checkbox" id="hush_checkbox" checked={hushMode} onChange={(e) => onHushChange(e.target.checked)} />
